...
public class issueBook extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String issueDate = df1.format(jDateChooser1.getDate());
        SimpleDateFormat df2 = new SimpleDateFormat("yyyy-MM-dd");
        String dueDate = df2.format(jDateChooser2.getDate());
        ...
        try{
            ...
            if(rs.next()){
                ...
                if(rs1.next()){
                    st.executeUpdate("insert into newissue values('"+bookID+"', '"+StudentID+"', '"+issueDate+"', '"+dueDate+"', '"+returnBook+"')");
